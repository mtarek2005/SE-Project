...
<main>
    ...
    <h4 class="feed-head"><a href="follower-list.php?id=<?= $target_user->UUID ?>">Followers</a></h4>
    <h4 class="feed-head"><a href="following-list.php?id=<?= $target_user->UUID ?>">Following</a></h4>
    <?php if (!$same_user) : ?>
        ...
        <?php else: ?>
            <h4 class="feed-head"><a href="#">Edit Profile</a></h4>
    <?php endif; ?>
    <?php
    $feed = new UserFeed;
